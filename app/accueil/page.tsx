    ...
    <div className="homepage">
        ...
        <div className=" row description__profil">
          ...
          <div className="profile-info col-md-8 col-xs-12">
            ...
            <div className="d-flex justify-star align-items-center info">
              ...
              <div>
                Licence Appliquée en Développement Système d’information
              </div>
            </div>
          </div>
      ...
      <div className="titles profession  ">
        ...
        >
          ...
          <img className="w-full rounded" src="/assets/athbbord.PNG"  alt="athbbord"/>
          <img className="w-full rounded" src="/assets/bboard.PNG"   alt="bboard"/>
          <img className="w-full rounded" src="/assets/authwalopst.PNG"   alt="authwalopst"/>
          <img className="w-full rounded" src="/assets/wallpost.PNG"   alt="wallpost"/>
          <img className="w-full rounded" src="/assets/yellow.PNG"   alt="yellow"/>
          <img className="w-full rounded" src="/assets/siteyellow.PNG"   alt="siteyellow"/>
